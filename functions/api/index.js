...
const apiSeriesUrl = 'https://api.themoviedb.org/3/tv/';
...
async function fetchRecommendations(movieId, seriesId) {
    const urls = [
        `${apiMovieUrl}${movieId}/recommendations`,
        `${apiSeriesUrl}${seriesId}/recommendations`
    ];
 ...
 * @async
 * @param {('movie'|'tv')} type - The type of content to fetch. Must be either 'movie' or 'tv'.
